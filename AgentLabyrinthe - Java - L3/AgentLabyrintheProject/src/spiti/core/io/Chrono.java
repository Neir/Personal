...
public class Chrono {
 ...
 public void affiche(long millis){
	 ...
	 if (secondes>=60){
		 ...
		 System.out.println("temps écoulé : "+secondes + " s "+ms + " millisecondes");
		 return;
	 }
	 if (minutes>=60){
		 heures = minutes/60;
		 m = minutes - 60*heures;
		 System.out.println("temps écoulé : "+heures + " h "+m + " mn "+s + " s "+ms + " millisecondes");
		 return;
	 }
	 else  {
		 System.out.println("temps écoulé : "+minutes + " mn "+s + " s "+ms + " millisecondes");
		 return;
	 }
 }
}
